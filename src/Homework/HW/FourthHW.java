...
/*    скажу честно , это не мой код . Я долго пытался разобраться и пытался придумать
что то своё , не смотрел 5 урок чтобы не смотреть подсказки, но из за завала наработе,
и необходимости большего времения для понимания материала. решил скопипастить код который пытался сам читать
и в котором как с примером пытался разбираться
*/
